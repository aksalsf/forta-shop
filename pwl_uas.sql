...
(100, 'admin@kajol.co.id', '$2y$12$NanFW5L4LJTe4YcG4asEJ.2Ut6QGD7XLeiHySyORzBZFdVpkOI/AS');
...
INSERT INTO `tb_pelanggan` (`id_pelanggan`, `nama`, `surel`, `no_ponsel`, `kata_sandi`, `alamat`, `status`) VALUES
...
(12, 'Budi Santoso', 'budist@yahoo.com', '6285643210099', '$2y$12$dBW9zwPBvwVNaD7sNcto5OMNqYP4Q6l/8TK5lgf4A6YdtOhd.yZWS', '-', 'ACTIVE'),
...
--
ALTER TABLE `tb_brand`
  MODIFY `id_brand` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT for table `tb_detail_pesanan`
--
ALTER TABLE `tb_detail_pesanan`
  MODIFY `id_detail_pesanan` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `tb_pelanggan`
--
ALTER TABLE `tb_pelanggan`
  MODIFY `id_pelanggan` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT for table `tb_pesanan`
--
ALTER TABLE `tb_pesanan`
  MODIFY `id_pesanan` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
